...
function MM_goToURL() { //v3.0
  ...
  for (i=0; i<(args.length-1); i+=2) eval(args[i]+".location='"+args[i+1]+"'");
   ...
   <body onload="createGantChart()">
      ...
      <!-- Title  -->
      <div align="center"><h2>Plan of Record 2021</h2></div>
      <div align="center">
<?php // PORDate(); ?>
POR Version 12/20/2021 (Includes approved CR's as of 12/17/2021) 
</div>
      ...
      <div class="main">
         ...
         <!-- Clear Selection and Download Buttons Container  -->
            <div class="downloadReset" align = "center" >
               ...
               <button class="buttons" onClick="MM_goToURL('parent','https://coxcomminc.sharepoint.com/:f:/r/teams/engmgmtoffice/Strat%20Plat%20POR/POR21?csf=1&web=1&e=bjwhTA');return document.MM_returnValue"> Link to Download Excel File </button>
            </div>
               ...
               <table width="98%" class="table-bordered table-hover table-striped gant_table" id="tablestyle">
                  <thead>
                     <tr bgcolor="#00aaf5" class = "gant_table__header" style="font-size:8px; color:white">
                        ...
                        <th colspan="5" width="30"><div align="center">Oct 20</div></th>
                        ...
                        <th colspan="4" width="30"><div align="center">Apr 21</div></th>
                        <th colspan="4" width="30"><div align="center">May 21</div></th>
                        <th colspan="5" width="30"><div align="center">Jun 21</div></th>
                        <th colspan="4" width="30"><div align="center">Jul 21</div></th>
                        <th colspan="4" width="30"><div align="center">Aug 21</div></th>
                        <th colspan="5" width="30"><div align="center">Sep 21</div></th>
                        <th colspan="4" width="30"><div align="center">Oct 21</div></th>
                        <th colspan="4" width="30"><div align="center">Nov 21</div></th>
                        <th colspan="5" width="30"><div align="center">Dec 21</div></th>
                        <th colspan="4" width="30"><div align="center">Jan 22</div></th>
                        <th colspan="4" width="30"><div align="center">Feb 22</div></th>
                        <th colspan="5" width="30"><div align="center">Mar 22</div></th>
                     </tr>
