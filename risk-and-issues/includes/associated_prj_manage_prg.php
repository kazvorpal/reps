...
<!-- <div align="center">Select any project associated with this Risk or Issue</div> -->
  <form action="" method="post" class="navbar-form navbar-center" id="formfilter">
    ...
    <?php if ($ri_type === "Risk"){ ?> 
      <form action="../program-risk-update.php?regions=<?php echo $regions?>&drivertime=<?php echo $drivertime; ?>&status=1&uid=<?php echo $uid ?>&progname=<?php echo $MLMProgNm; ?>&progkey=<?php echo $MLMProgKey?>&progRIkey=<?php echo $progRIKey; ?>&ri_type=<?php echo $ri_type ?>&action=<?php echo $action ?>&fscl_year=<?php echo $fiscal_year?>&rikey=<?php echo $RiskAndIssue_Key ?>" method="post" class="navbar-form navbar-center" id="assProjects" name="assProjects">
    <?php } elseif ($ri_type === "Issue"){ ?> 
      <form action="../program-issue-update.php?regions=<?php echo $regions?>&drivertime=<?php echo $drivertime; ?>&status=1&uid=<?php echo $uid ?>&progname=<?php echo $MLMProgNm; ?>&progkey=<?php echo $MLMProgKey?>&progRIkey=<?php echo $progRIKey; ?>&ri_type=<?php echo $ri_type ?>&action=<?php echo $action ?>&fscl_year=<?php echo $fiscal_year?>&rikey=<?php echo $RiskAndIssue_Key ?>" method="post" class="navbar-form navbar-center" id="assProjects" name="assProjects">
    <?php } ?>
