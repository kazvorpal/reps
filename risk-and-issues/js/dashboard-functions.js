...
const fieldfilter = (ri, test, url) => {
  ...
  const fieldswitch = {
    ...
    PRJI_Estimated_Act_Ts: () => ri.PRJI_Estimated_Act_Ts ? getobjectdate(ri.PRJI_Estimated_Act_Ts) : "N/A",
    PRJI_Estimated_Mig_Ts: () => ri.PRJI_Estimated_Mig_Ts ? getobjectdate(ri.PRJI_Estimated_Mig_Ts) : "N/A",
