...
const setlists = () => {
  ...
  rifields = (mode == "program") ? {"RiskAndIssue_Key": {name: "ID", width: "3"}, "category": {name: "category", width: "3"}, "Fiscal_Year": {name: "FY", width: "4"}, "MLMProgram_Nm": {name: "Program", width: "9"}, "subprogram": {name: "Subprogram", width: "9"}, "MLMRegion_Cd": {name: "Region", width: "6"}, "LastUpdateBy_Nm": {name: "Owner", width: "10"}, "ImpactLevel_Nm": {name: "Impact Level", width: "10"}, "RIDescription_Txt": {name: "Description", width: "10"}, age: {name: "Age", width: 3}, actionplandate: {name: "Action Plan Date", width: 6}, "ActionPlanStatus_Cd": {name: "Action Plan", width: "27"}, "ForecastedResolution_Dt": {name: "Forecast Res Date", width: "6"}, "ResponseStrategy_Cd": {name: "Response Strategy", width: "5"}, "RIOpen_Hours": {name: "Open Duration", width: "6"}, "RIActive_Flg": {name: "Status", width: "6"}} 
    : (mode == "portfolio") ? {"Fiscal_Year": {name: "FY", width: "4"}, "RIType_Cd": {name: "Type", width: "4"}, "RiskAndIssue_Key": {name: "ID", width: "3"}, "RI_Nm": {name: "R/I Name", width: "8"}, "MLMProgram_Nm": {name: "Program", width: "9"}, "LastUpdateBy_Nm": {name: "Owner", width: "10"}, "ImpactLevel_Nm": {name: "Impact", width: "10"}, "RIDescription_Txt": {name: "Description", width: "10"}, "ResponseStrategy_Nm": {name: "Response Strategy", width: "5"}, age: {name: "Age", width: 3}, actionplandate: {name: "Action Plan Date", width: 6}, "ActionPlanStatus_Cd": {name: "Action Plan", width: "27"}, "RIActive_Flg": {name: "Status", width: "6"}, "ForecastedResolution_Dt": {name: "Forecast Res Date", width: "6"}, "RIOpen_Hours": {name: "Open Duration", width: "6"}}
