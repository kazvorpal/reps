...
const setlists = () => {
  ...
  // rifields = (mode == "program") ? {"RiskAndIssue_Key": {name: "ID", width: "3"}, "category": {name: "category", width: "3"}, "global": {name: "Global", width: "3"}, "Fiscal_Year": {name: "FY", width: "4"}, "MLMProgram_Nm": {name: "Program", width: "9"}, "subprogram": {name: "Subprogram", width: "9"}, "MLMRegion_Cd": {name: "Region", width: "6"}, "LastUpdateBy_Nm": {name: "Owner", width: "10"}, "ImpactLevel_Nm": {name: "Impact Level", width: "10"}, "ActionPlanStatus_Cd": {name: "Action Plan", width: "27"}, "ForecastedResolution_Dt": {name: "Forecast Res Date", width: "6"}, "ResponseStrategy_Cd": {name: "Response Strategy", width: "5"}, "RIOpen_Hours": {name: "Open Duration", width: "6"}, "RIActive_Flg": {name: "Status", width: "6"}} 
  rifields = (mode == "program") ? {"RiskAndIssue_Key": {name: "ID", width: 3}, "category": {name: "category", width: 3}, "Fiscal_Year": {name: "FY", width: 4}, "MLMProgram_Nm": {name: "Program", width: 9}, "subprogram": {name: "Subprogram", width: 9}, "MLMRegion_Cd": {name: "Region", width: 6}, "LastUpdateBy_Nm": {name: "Owner", width: 5}, "ImpactLevel_Nm": {name: "Impact Level", width: 5}, "RIDescription_Txt": {name: "Description", width: 17}, age: {name: "Age", width: 3}, actionplandate: {name: "Action Plan Date", width: 6}, "ActionPlanStatus_Cd": {name: "Action Plan", width: 17}, "ForecastedResolution_Dt": {name: "Forecast Res Date", width: 6}, "ResponseStrategy_Cd": {name: "Response Strategy", width: 3}, "RIOpen_Hours": {name: "Open Duration", width: 5}, "RIActive_Flg": {name: "Status", width: 5}} 
    : (mode == "portfolio") ? {"Fiscal_Year": {name: "FY", width: 3}, "RIType_Cd": {name: "Type", width: 2}, "RiskAndIssue_Key": {name: "ID", width: 2}, "RI_Nm": {name: "R/I Name", width: 8}, "MLMProgram_Nm": {name: "Program", width: 9}, "LastUpdateBy_Nm": {name: "Owner", width: 6}, "ImpactLevel_Nm": {name: "Impact", width: 6}, "RIDescription_Txt": {name: "Description", width: 18}, "ResponseStrategy_Nm": {name: "Response Strategy", width: 4}, age: {name: "Age", width: 3}, actionplandate: {name: "Action Plan Date", width: 6}, "ActionPlanStatus_Cd": {name: "Action Plan", width: 18}, "RIActive_Flg": {name: "Status", width: 4}, "ForecastedResolution_Dt": {name: "Forecast Res Date", width: 5}, "RIOpen_Hours": {name: "Open Duration", width: 6}}
    // : (mode == "portfolio") ? {"Fiscal_Year": "FY", "RIType_Cd": "Type", "RiskAndIssue_Key": "ID", "RI_Nm": "R/I Name", "MLMProgram_Nm": "Program", "LastUpdateBy_Nm": "Owner", "ImpactLevel_Nm": "Impact", "RIDescription_Txt": "Description", "ResponseStrategy_Nm": "Response Strategy", age: "Age", actionplandate: "Action Plan Date", "ActionPlanStatus_Cd": "Action Plan", "RIActive_Flg": "Status", "ForecastedResolution_Dt": "Forecast Res Date", "RIOpen_Hours": "Open Duration"}
    : {"RiskAndIssue_Key": "ID", "RI_Nm": "R/I Name", "RIType_Cd": "Type", "EPSProject_Nm": "Project Name", "RIIncrement_Num": "Group ID", "EPSProgram_Nm": "Program", "EPSSubprogram_Nm": "Subprogram", "LastUpdateBy_Nm": "Owner", "Fiscal_Year": "FY", "EPSRegion_Cd": "Region", "EPSMarket_Cd": "Market", "EPSFacility_Cd": "Facility", "ImpactLevel_Nm": "Impact", "RIDescription_Txt": "Description", age: "Age", actionplandate: "Action Plan Date", "ActionPlanStatus_Cd": "Action Plan", "ForecastedResolution_Dt": "Forecast Res Date", "ResponseStrategy_Nm": "Response Strategy", "RIOpen_Hours": "Open Duration"};
  ...
  changelog = {"changelogdate": "Change Log Requested Date", "RiskAndIssue_Key": "Risk ID", "RI_Nm": "Risk Name", "EPSProject_Nm": "Project Name", "EPSProgram_Nm": "Program", "EPSRegion_Abb": "Region", "EPSMarket_Cd": "Market", "EPSFacility_Cd": "Facility", "ImpactLevel_Nm": "Impact", LastUpdateBy_Nm: "Requestor", requestedaction: "Requested Action", Reason_Txt: "Reason", programmanager: "Program Manager"};
  
  // "RIType_Cd": "Type", "RIIncrement_Num": "Group ID", groupcount: "Proj Group Count", grouptype: "Group Type", "RIActive_Flg": "Status", "EPSSubprogram_Nm": "Sub-Program", "ImpactArea_Nm": "Impact Area", "ImpactLevel_Nm": "Impact Level",	"RiskProbability_Nm": "Probability", "LastUpdateBy_Nm": "Owner", "ScopeDescriptor_Txt": "Descriptor", "RIDescription_Txt": "Description", "driver": "Driver", "ResponseStrategy_Nm": "Response", "POC_Nm": "POC Name", "POC_Department": "POC Group", "TransferredPM_Flg": "Transferred to PDM", "AssociatedCR_Key": "CR", "AssociatedCR_Key": "CR", "RiskRealized_Flg": "Risk Realized", age: "Age", actionplandate: "Action Plan Date", "ActionPlanStatus_Cd": "Action Plan", "RIOpen_Hours": "Duration", "Created_Ts": "Creation Date", "quartercreated": "Quarter Created", "monthcreated": "Month Created", "LastUpdateBy_Nm": "Last Update By", "Last_Update_Ts": "Last Update Date", "ForecastedResolution_Dt": "Resolution Date", "RIClosed_Dt": "Date Closed", "quarterclosed": "Quarter Closed", "monthclosed": "Month Closed"}
}
//
