                ...
                <td>
                  <div style="padding: 0px 0px 0px 30px">
                    <p><strong>Select Regions
                      ...
                      <label>
                        <input type="checkbox" name="Region[]" value="All" id="Region" onClick="toggle(this); updatebox()" class="required_group_reg">
                        Select All</label>
                      <br>
                      <label>
                        <input type="checkbox" name="Region[]" value="Corporate" id="Region_6" onClick="updatebox()" class="required_group_reg">
                        Corporate (COR)</label>
                      <br>
                      <label>
                        <input type="checkbox" name="Region[]" value="California" id="Region_0" onClick="updatebox()" class="required_group_reg">
                        California (CA)</label>
                      <br>
                      <label>
                        <input type="checkbox" name="Region[]" value="Central" id="Region_1" onClick="updatebox()" class="required_group_reg">
                        Central (CE)</label>
                      <br>
                      <label>
                        <input type="checkbox" name="Region[]" value="Northeast" id="Region_2" onClick="updatebox()" class="required_group_reg">
                        Northeast (NE)</label>
                      <br>
                      <label>
                        <input type="checkbox" name="Region[]" value="Southeast" id="Region_3" onClick="updatebox()" class="required_group_reg">
                        Southeast (SE)</label>
                      <br>
                      <label>
                        <input type="checkbox" name="Region[]" value="Southwest" id="Region_4" onClick="updatebox()" class="required_group_reg">
                        Southwest (SW)</label>
                      <br>
                      <label>
                        <input type="checkbox" name="Region[]" value="Virginia" id="Region_5" onClick="updatebox()" class="required_group_reg">
                        Virginia (VA)</label>
                      <br>
                      </p>
                    </div>
