...
<?php
    ...
    $descriptor = 'AVI PRG 2036';  // RI DESCRIPTOR
    ...
    //CALL THE PROCEDURE
        ...
        $tsql_callSP = "{CALL [RI_MGT].[sp_SaveRiskandIssues](?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)}"; //QA

    //echo json_encode($params);
    //exit();

   //EXECUTE PROCEDDURE
    $stmt3 = sqlsrv_query( $data_conn, $tsql_callSP, $params); //QA
