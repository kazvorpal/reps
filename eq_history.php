    ...
    <thead style="font-size:10px">
        <tr>  
            <th data-field="OrderType" data-filter-control="select" data-sortable="true" data-title-tooltip="Order Type - Internal Order or Purchase Order">ORDER TYPE</th>
          	<th data-field="OrderNumber" data-filter-control="select" data-sortable="true"><span data-toggle="tooltip" data-placement="top" title="Order Number - IO Number">ORDER #</span></th>
            ...
            <th data-field="EPS_Program" data-filter-control="select" data-sortable="true" data-title-tooltip="EPS Program Name">EPS PROGRAM</th>
          	<!---->
            <th data-field="ProjectName" data-filter-control="select" data-sortable="true"><span data-toggle="tooltip" data-placement="top" title="Project Name">PROJECT NAME</span></th>
            ...
            <th data-field="orderqty" data-filter-control="select" data-sortable="true"><span data-toggle="tooltip" data-placement="top" title="Order Quantitiy - Quantity Ordered">ORDER QTY</span></th>
            ...
            <th data-field="CoxPrt" data-filter-control="select" data-sortable="true"><span data-toggle="tooltip" data-placement="top" title="COX Part Number - ">COX PART#</span></th>
            ...
            <th data-field="wwtquote" data-filter-control="select" data-sortable="true"><span data-toggle="tooltip" data-placement="top" title="WWT Quote Number ">WWT QUOTE #</span></th>
            <th data-field="franchise" data-filter-control="select" data-sortable="true"><span data-toggle="tooltip" data-placement="top" title="Franchise - When the material is picked up / Interfaced">FRANCHISE</span></th>
            ...
            <th data-field="coxrequestdate" data-filter-control="select" data-sortable="true"><span data-toggle="tooltip" data-placement="top" title="COX Request Date - Requested Need By Date?">COX REQUSITION DATE</span></th>
            ...
            <th data-field="requesternmr" data-filter-control="select" data-sortable="true">REQUESTER</th>
            <th data-field="preparer" data-filter-control="select" data-sortable="true">PREPARER</th>
            ...
            <th data-field="helpDeskTickeNum" data-filter-control="select" data-sortable="true" data-visible="false"><span data-toggle="tooltip" data-placement="top" title="GL Code ">HELP DESK TICKET#</span></th>
            <th data-field="lastorcleupdate" data-filter-control="select" data-sortable="true"><span data-toggle="tooltip" data-placement="top" title="Last Oracle Update ">LAST ORACLE UPDATE</span></th>
          ...
          <th data-field="originsourcetype" data-filter-control="select" data-sortable="true"><span data-toggle="tooltip" data-placement="top" title="Source of Origin Type - This is my mapping of Source Org to PDC, AFC, IMM, TR">SOURCE ORG TYP</span></th>
            ...
            <th data-field="glcode" data-filter-control="select" data-sortable="true"><span data-toggle="tooltip" data-placement="top" title="GL Code ">GL CODE</span></th>
            <th data-field="seperetor"><span class="glyphicon glyphicon-plus"></span></th><!--Leave Empty-->
            <!-- Hidden Fields-->
          <th data-field="GL_Project_Id" data-filter-control="select" data-sortable="true" data-visible="false" data-title-tooltip="PPM Number - PPM">GL PROJECT ID</th>
          <th data-field="GL_Project_Start_Dt" data-filter-control="select" data-sortable="true" data-visible="false" data-title-tooltip="PPM Number - PPM">GL PROJECT START DATE</th>
          <th data-field="OrderStatus_Cd" data-filter-control="select" data-sortable="true" data-visible="false" data-title-tooltip="PPM Number - PPM">ORDER STATUS</th>
          <th data-field="LOB_Cd" data-filter-control="select" data-sortable="true" data-visible="false" data-title-tooltip="PPM Number - PPM">LOB</th>
          <th data-field="PurchasedType_Cd" data-filter-control="select" data-sortable="true" data-visible="false" data-title-tooltip="PPM Number - PPM">PURCHASED TYPE</th>
          <th data-field="SC_TotalOnHand_Qty" data-filter-control="select" data-sortable="true" data-visible="false" data-title-tooltip="PPM Number - PPM">TOTAL ON HAND QTY</th>
          <th data-field="SC_Next30DaysDemand_Qty" data-filter-control="select" data-sortable="true" data-visible="false" data-title-tooltip="PPM Number - PPM">NEXT 30 DAYS DEMAND QTY</th>
          <th data-field="SC_TotalDemand_Qty" data-filter-control="select" data-sortable="true" data-visible="false" data-title-tooltip="PPM Number - PPM">TOTAL DEMAND QTY</th>
          <th data-field="Calc_DeliveryWindow_Cd" data-filter-control="select" data-sortable="true" data-visible="false" data-title-tooltip="PPM Number - PPM">CALCULATED DELIVERY WINDOW</th>
           </tr>
    </thead>
...
<div id="popover_info_content" style="display: none; padding-bottom:6">
  ...
  Example:  1234554321ERQER,3234554321SRGFD,4234554321SYDEM
</div>
<!-- End Search Criteria -->
