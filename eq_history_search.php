...
<?php include ("sql/order_history_search.php");?>
...
<div class="row">
    ...
    <a href="equipment/export.php?sqlex=<?php echo urlencode($sql_eqh) ?>" class="btn btn-default">Export Results</a>
