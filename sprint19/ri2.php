...
<?php
                ...
                //FIND PROJECT RISK AND ISSUES - TO BE DELETED ON 1.26.2022
                //$uid = $_GET['uid'];
                //$proj_name = $_GET['prj_name'];
                ...
                Where [RiskandIssues_Users].[Username] = '$windowsUser'and [PROJ_ID] = '$projID'";
								$stmt_authorize = sqlsrv_query( $conn_COX_QA, $sql_authorize );
...
<table width="98%" border="0" class="table table-bordered table-striped table-hover">
  <tbody>
    ...
    <tr>
      ...
      <td align="center"><a href="risk-and-issues/details.php?rikey=<?php echo $row_risk_issue['RiskAndIssue_Key'];?>&fscl_year=<?php echo $fscl_year;?>&proj_name=<?php echo $proj_name;?>"><span class="glyphicon glyphicon-zoom-in" style="font-size:12px;"></span></a></td>
    </tr>
    <?php } ?>
  </tbody>
</table>
