...
<div style="padding: 20px;">
  <form action="confirm.php" method="post" id="programRisk"  oninput="Namex.value = NameA.value +' '+NameB.value+' '+NameA1.value+' '+NameA2.value+' '+NameC.value">
        ...
        <tr>
          <td align="left" valign="top"><div class="box">
            ...
            <tbody>
              ...
              <tr>
                <td><label for="NameA2">Risk Descriptor<br>
                  </label>
              ...
              <tr>
                ...
                <div style="padding: 0px 0px 0px 30px">
                    <p><strong>Regions Select
                      ...
                      <br>
                      <label>
                        <input type="checkbox" name="Region[]" value="Souteast" id="Region_3" onClick="updatebox()">
                        Southeast (SE)</label>
                      <br>
                      <label>
