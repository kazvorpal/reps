...
<main align="center">
  ...
  <ul class="nav nav-tabs" role="tablist">
    <li role="presentation" class="active"><a href="#home" aria-controls="home" role="tab" data-toggle="tab">Program Risk</a></li>
    <li role="presentation"><a href="#profile" aria-controls="profile" role="tab" data-toggle="tab">Program Issue</a></li>
  </ul>
...
<form action="confirm.php" method="post" id="projectRisk">
  <table width="100%" border="0" cellpadding="10" cellspacing="10">
    <tbody>
      <tr>
        <th align="left"><h4 style="color: #00aaf5">PROGRAM RISK</h4></th>
...
<form action="confirm.php" method="post" id="projectRisk">
  <table width="100%" border="0" cellpadding="10" cellspacing="10">
    <tbody>
      <tr>
        <th align="left"><h4 style="color: #00aaf5">PROGRAM ISSUE</h4></th>
        <th colspan="2" align="left">&nbsp;</th>
      </tr>
      <tr>
        <td width="50%" align="left">
