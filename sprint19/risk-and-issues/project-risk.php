...
<div style="padding: 20px;">
  ...
  <table width="100%" border="0" cellpadding="10" cellspacing="10">
      <tbody>
        <tr>
          <th width="50%" colspan="2" align="left">
            <div id="myRisk">
            ...
            <tbody>
              ...
              <tr>
                <td><label for="Created From">Issue Descriptor<br>
                  ...
                  <input name="Descriptor" type="text" required="required" class="form-control" id="Descriptor"></td>
                </tr>
              <tr>
        ...
        <tr>
          <td colspan="4" align="left"><h4 style="color: #00aaf5">DRIVERS</h4>
            <div class="box">
        ...
        <tr>
          <td colspan="4" align="left"><h4  style="color: #00aaf5">IMPACT</h4></td>
          </tr>
        <tr>
          <td colspan="4" align="left">
			<div class="box"> 
        ...
        <tr>
          <td colspan="4" align="left"><h4 style="color: #00aaf5">CURRENT TASK POC</h4>          </td>
          </tr>
        <tr>
          <td colspan="4" align="left">
            <div class="box">
        ...
        <tr>
          <td colspan="4" align="left"><div style="padding-left: 10px">
            <h4 style="color: #00aaf5">RESPONSE STRATEGY</h4>
          </div></td>
          </tr>
        <tr>
          <td colspan="4" align="left"><div class="box">
...
<table width="100%" border="0" cellpadding="10" cellspacing="10">
  <tbody>
    ...
    <tr>
      <td>
		  <div id="forcastedDate" class="box">
              <input type="checkbox" 
                name="Unknown" 
                id="Unknown" 
                onChange="unKnown()"
      ...
      <td>
        ...
        <tr>
          <td colspan="4" align="left"><h4 style="color: #00aaf5">ACTION PLAN</h4>
        ...
        <tr>
        <td colspan="4" align="left"><h4 style="color: #00aaf5">PROJECT ASSOCIATION</h4></td>
        </tr>
        <tr>
          <td colspan="4">
        ...
        <tr>
          <td colspan="4" align="left"><h4 style="color: #00aaf5">RISK REALIZED</h4></td>
        </tr>
        <tr>
          <td colspan="4" align="left">
            <div class="box">
