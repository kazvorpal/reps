...
function MM_goToURL() { //v3.0
  ...
  for (i=0; i<(args.length-1); i+=2) eval(args[i]+".location='"+args[i+1]+"'");
   ...
   <body onload="createGantChart()">
      ...
      <!-- Title  -->
      <div align="center"><h2>StratPlat Plan of Record 2020</h2></div>
      <div align="center">
<?php // PORDate(); ?>
POR Version 12/21/2020 (Includes approved CR's as of 12/18/2020) 
</div>
      ...
      <div class="main">
         ...
         <!-- Clear Selection and Download Buttons Container  -->
            <div class="downloadReset" align = "center" >
              ...
              <button class="buttons" onClick="MM_goToURL('parent','https://coxcomminc.sharepoint.com/:f:/r/teams/engmgmtoffice/Strat%20Plat%20POR/POR20?csf=1&web=1&e=ocdneV');return document.MM_returnValue"> Download Excel </button>
            </div>
               ...
               <table width="98%" class="table-bordered table-hover table-striped gant_table" id="tablestyle">
                  <thead>
                     <tr bgcolor="#00aaf5" class = "gant_table__header" style="font-size:8px; color:white">
                        ...
                        <th>Migrate<br>Month</th>
                        <th>CR Num</th>
                        <th>EPA CD</th>

                        <th colspan="5" width="30"><div align="center">Oct 19</div></th>
                        <th colspan="4" width="30"><div align="center">Nov 19</div></th>
                        <th colspan="5" width="30"><div align="center">Dec 19</div></th>
                        <th colspan="4" width="30"><div align="center">Jan 20</div></th>
                        <th colspan="4" width="30"><div align="center">Feb 20</div></th>
                        <th colspan="5" width="30"><div align="center">Mar 20</div></th>
                        <th colspan="4" width="30"><div align="center">Apr 20</div></th>
                        <th colspan="4" width="30"><div align="center">May 20</div></th>
                        <th colspan="5" width="30"><div align="center">Jun 20</div></th>
                        <th colspan="4" width="30"><div align="center">Jul 20</div></th>
                        <th colspan="4" width="30"><div align="center">Aug 20</div></th>
                        <th colspan="5" width="30"><div align="center">Sep 20</div></th>
                        <th colspan="4" width="30"><div align="center">Oct 20</div></th>
                        <th colspan="4" width="30"><div align="center">Nov 20</div></th>
                        <th colspan="5" width="30"><div align="center">Dec 20</div></th>
                        <th colspan="4" width="30"><div align="center">Jan 21</div></th>
                        <th colspan="4" width="30"><div align="center">Feb 21</div></th>
                        <th colspan="5" width="30"><div align="center">Mar 21</div></th>
                     </tr>
