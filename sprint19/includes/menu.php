<nav class="navbar navbar-default" style="width:100%"> <!-- Brand and toggle get grouped for better mobile display -->
  <div class="navbar-header" style="padding-top:5px" >
    <a class="navbar-brandx" href="https://catl0dwas10222.corp.cox.com/sprint17">
      <img src="https://catl0dwas10222.corp.cox.com/images/rEPS-logo-2021-sm.png" width="90" alt=""/>
    </a> 
  </div>
  <!-- Collect the nav links, forms, and other content for toggling -->
  <div class="collapse navbar-collapse" id="myDefaultNavbar1">
    <ul class="nav navbar-nav">
      <li><a href="https://catl0dwas10222.corp.cox.com/regional-view.php">Regional View<span class="sr-only">(current)</span></a>
      	<ul class="dropdown-menu" role="menu">
        	
        	<li><a href="https://catl0dwas10222.corp.cox.com/index_b.php">Risks & Issues Only</a></li>
        </ul>
      
      </li> 
      <li><a href="https://catl0dwas10222.corp.cox.com/esp-status-details-index.php">Detailed Phase Report<span class="sr-only">(current)</span></a></li>
      <li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">POR<span class="caret"></span><span class="sr-only">(current)</span></a>
      		<ul class="dropdown-menu" role="menu">
              <li><a href="https://catl0dwas10222.corp.cox.com/por20">2020</a></li>
              <li><a href="https://catl0dwas10222.corp.cox.com/por21">2021</a></li>
              <li><a href="https://catl0dwas10222.corp.cox.com/por22">2022</a></li>
...
<!--              <li><a href="#">Something else here</a></li>
            ...
            <li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">Equipment Order History<span class="caret"></span><span class="sr-only">(current)</span></a>
      		<ul class="dropdown-menu" role="menu">
              <!--<li><a href="https://catl0dwas10222.corp.cox.com/por">2019</a></li>-->
              <li><a href="https://catl0dwas10222.corp.cox.com/equipment/oh.php">Equipment Search</a></li>
              <li><a href="https://catl0dwas10222.corp.cox.com/equipment/eq_history_search_bo.php">Back Order Search</a></li>
<!--              <li><a href="#">Something else here</a></li>
              <li class="divider"></li>
              <li><a href="#">Separated link</a></li>
              <li class="divider"></li>
      ...
      <li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">Risks and Issues<span class="caret"></span><span class="sr-only">(current)</span></a>
        <ul class="dropdown-menu" role="menu">
          <li><a href="https://catl0dwas10222.corp.cox.com/risk-and-issues/proj_prog_report">Program/Project</a></li>
          <li><a href="https://catl0dwas10222.corp.cox.com/risk-and-issues/aggregate_report">Aggregate</a></li>
        </ul>
      </li>


      <li><a href="https://catl0dwas10222.corp.cox.com/index_eps_status.php">EPS Status Report<span class="sr-only">(current)</span></a></li>
      <li><a href="https://catl0dwas10222.corp.cox.com/cr/">CR Overview<span class="sr-only">(current)</span></a></li>
