  ...
  <table width="98%" border="0" cellpadding="5" class="table table-bordered table-striped table-hover">
    ...
    <?php while ($row_risk_issue = sqlsrv_fetch_array($stmt_risk_issue, SQLSRV_FETCH_ASSOC)){ ?>
      ...
      <?php if($row_risk_issue['Global_Flg'] == 0) { ?>
        ...
        <?php } else { ?>
          <a href="risk-and-issues/global/details.php?rikey=<?php echo $row_risk_issue['RiskAndIssue_Key'];?>"><span class="glyphicon glyphicon-zoom-in" style="font-size:12px;"></a>
        <?php } ?>
      </td>
    </tr>
    <?php } ?>
...
<table width="98%" border="0" class="table table-bordered table-striped table-hover">
  <tbody>
    ...
    <tr>
      ...
      <td align="center"><a href="risk-and-issues/details-prg.php?au=<?php echo $uaccess ?>&rikey=<?php echo $row_risk_issue_cls['RiskAndIssue_Key'];?>&program=<?php echo $ri_program;?>&fscl_year=<?php echo $ri_fscl_yr;?>&proj_name=<?php echo $ri_proj_nm;?>&uid=<?php echo $uid; ?>&status=0&popup=false"><span class="glyphicon glyphicon-zoom-in" style="font-size:12px;"></span></a></td>
    </tr>
    <?php } ?>
  </tbody>
</table>
